...
export const Route = createFileRoute("/_authenticated/foundation")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Foundation curriculum: 12 topics from the digital world to the ethical hacking lifecycle." },
    ],
  }),
...
function FoundationIndex() {
  return (
    <div className="mx-auto max-w-6xl space-y-6 px-4 py-8 md:px-8">
      <header>
        <div className="text-xs font-medium uppercase tracking-[0.2em] text-cyber">Learn · Foundation</div>
        <h1 className="mt-1 text-3xl font-bold tracking-tight md:text-4xl">Cybersecurity Foundation</h1>
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          Twelve short topics that make the rest of the program click. Start at the top or jump to what you need.
        </p>
      </header>
        ...
        {FOUNDATION_TOPICS.map((t) => (
          ...
          >
            <div className="mb-4 flex items-start justify-between">
              ...
              <Badge variant="outline" className="text-[10px]">F{String(t.number).padStart(2, "0")}</Badge>
            </div>
